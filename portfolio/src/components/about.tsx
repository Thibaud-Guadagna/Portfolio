...
function About() {
  return (
    ...
    <div className="-mt-5 flex justify-between">
      ...
      <img src="/code.svg" alt="baliseHtml" className='h-50 m-5 opacity-20 sm:w-full' />
    </div>
    </section>
    ...
    <div className="flex justify-between items-center m-5 ">
      <img src="/mergelogo.svg" alt="Merge Logo" className='h-40 opacity-20 ml-20 mb-10 -mt-20' />
